...
contract DssSpellTest is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x8f3E97160F6677DF2245B83B9827C97042465F9E),        // populate with deployed spell if deployed
            deployed_spell_created:         1629218872,        // use get-created-timestamp.sh if deployed
